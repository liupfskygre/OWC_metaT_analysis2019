...
**option2, we have RSEM**
```
#use bowtie2 for mapping, output TPM and coverage and length

#could keep bam file for further filtering

#flexible to chagne the bowtie2 
```
